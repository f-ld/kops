...
replace k8s.io/apiserver => k8s.io/apiserver v0.0.0-20190319190228-a4358799e4fe

replace k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.0.0-20190325193600-475668423e9f

replace k8s.io/client-go => k8s.io/client-go v0.0.0-20190307161346-7621a5ebb88b

replace k8s.io/cloud-provider => k8s.io/cloud-provider v0.0.0-20190325195930-a624236cb1f2

replace k8s.io/utils => k8s.io/utils v0.0.0-20180726175726-66066c83e385
